#!/usr/bin/env python
"""Remote-eval version of the user's multi-seed aggregator.
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--norm_ranges", type=str, default=None, help="Optional JSON file with min/max ranges for NormalizedAvg")
